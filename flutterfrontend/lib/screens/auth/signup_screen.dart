            ...
            child: Column(
              ...
              children: [
                ...
                AppTextField(
                  ...
                  validator: (value) {
                    if (value == null || !RegExp(r'^[a-z0-9_]{4,20}$').hasMatch(value)) {
                      return 'Use 4–20 lowercase letters, numbers, or _';
                    }
                    return null;
                  },
                ),
                ...
                AppTextField(
                  ...
                  validator: (value) {
                    if (value != null && value.isNotEmpty && !value.contains('@')) return 'Enter a valid email';
                    return null;
                  },
                ),
                const SizedBox(height: 16),
