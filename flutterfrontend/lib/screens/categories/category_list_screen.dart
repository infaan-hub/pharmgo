...
class CategoryListScreen extends ConsumerWidget {
  ...
  Widget _buildCategories(BuildContext context, WidgetRef ref, List<Category> categories) {
    final displayCategories = categories.isNotEmpty
        ? categories
        : [
            Category(id: '1', name: 'Prescription', icon: 'prescription'),
            Category(id: '2', name: 'OTC', icon: 'otc'),
            Category(id: '3', name: 'Vitamins', icon: 'vitamins'),
            Category(id: '4', name: 'Personal Care', icon: 'personal_care'),
            Category(id: '5', name: 'Baby Care', icon: 'baby_care'),
            Category(id: '6', name: 'Diabetes', icon: 'diabetes'),
            Category(id: '7', name: 'Heart Care', icon: 'heart'),
            Category(id: '8', name: 'Ayurveda', icon: 'ayurveda'),
          ];
