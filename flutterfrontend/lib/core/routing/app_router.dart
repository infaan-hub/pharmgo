...
class AppRouter {
  ...
  static GoRouter router(Ref ref) => GoRouter(
    ...
    redirect: (context, state) {
      ...
      const publicRoutes = {splash, onboarding, getStarted, signup, login, forgotPassword, otp, resetPassword};
      if (!isAuthenticated && !publicRoutes.contains(location)) return login;
      if (isAuthenticated && publicRoutes.contains(location) && location != splash) return home;
      return null;
    },
    routes: [
